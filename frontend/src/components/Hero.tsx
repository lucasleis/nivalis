...
import { fadeUp, fadeUpDelayed, fadeScale } from "../motion/variants";
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        <motion.div {...fadeUp} className="mb-10">
          <div
            className="inline-flex items-center justify-center w-24 h-24 mb-8 rounded-3xl
            bg-gradient-to-br from-orange-500 to-blue-600 shadow-2xl shadow-orange-500/20
            dark:shadow-orange-400/10"
          >
          ...
          <p
            className="mt-4 text-sm md:text-base uppercase tracking-[0.3em]
